...
export const MayorAttackPvPBase = z
  .function()
  .args(
    ExtendedGeneral,
    Display,
  ...
  .implement(
    (
      ...
      if (DEBUG) {
        console.log(`${eg.name}: MayorAttackPvP starting`);
      }
      ...
      if (DEBUG) {
        console.log(`MayorAttackPvP: ${eg.name}: BSS: ${BSS}`);
        console.log(
          `MayorAttackPvP: ${eg.name}: specialities: ${specialities}`,
        );
        console.log(`MayorAttackPvP: ${eg.name}: BAS: ${BAS}`);
        console.log(`MayorAttackPvP: ${eg.name}: AES: ${AES}`);
        console.log(`MayorAttackPvP: ${eg.name}: TLGS (BSS & 34SS): ${TLGS}`);
      }
