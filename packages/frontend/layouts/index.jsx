//portions copyright Luke Schierer.
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
// SPDX-License-Identifier: MIT-0
import React, { useEffect, useRef, useState } from 'react';
import { createRoot } from 'react-dom/client';
import intersection from 'lodash/intersection';
import { FILTERING_PROPERTIES } from '../components/table-property-filter/table-property-filter-config';
import Pagination from '@cloudscape-design/components/pagination';
import Table from '@cloudscape-design/components/table';
import PropertyFilter from '@cloudscape-design/components/property-filter';
import { Breadcrumbs, ToolsContent } from '../components/table/common-components';
import { CustomAppLayout, Navigation, Notifications, TableNoMatchState } from '../components/commons/common-components';
import { FullPageHeader } from '../components/commons';
import {
...
import { useColumnWidths } from '../components/commons/use-column-widths';
import { COLUMN_DEFINITIONS, DEFAULT_PREFERENCES, Preferences } from '../components/commons/table-config';
import { useDistributions } from '@functions/src/lib/server-side-table-hooks';
