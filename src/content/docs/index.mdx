...
<CardGrid stagger>
    <a href="/generals/"><Card title="Generals">An opinionated guide to picking the various generals you need.</Card></a>
    <a href="/svs/"><Card title="SvS">An introductory reference to preparing to participate in the bi-weekly Server versus Server event.</Card></a>
    <a href="/monsters/"><Card title="Monsters">An introduction to hunting monsters, with a collection of example reports.</Card></a>
    <a href="/reference/"><Card title="Reference">Bare-bones reference material to help make sense of the other content.</Card></a>
</CardGrid>