...
<CardGrid stagger>
    ...
    <Card title="SvS">An introductory reference to preparing to participate in the bi-weekly Server versus Server event.</Card>
    <Card title="Monsters">An introduction to hunting monsters, with a collection of example reports.</Card>
    <Card title="Reference">Bare-bones reference material to help make sense of the other content.</Card>
</CardGrid>