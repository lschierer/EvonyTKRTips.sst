...
<CardGrid stagger>
    <LinkCard href="/generals/" title="Generals">An opinionated guide
        to picking the various generals you need.</LinkCard>
    <LinkCard href="/svs/" title="SvS">An introductory reference to
        preparing to
        participate in the bi-weekly Server versus Server event.</LinkCard>
     <LinkCard href="/monsters/" title="Monsters">An introduction to
    hunting monsters, with
    a collection of example reports.</LinkCard>
    <LinkCard href="/reference/" title="Reference">Bare-bones reference
        material to help make sense of the other content.</LinkCard>
</CardGrid>
