...
<CollapsibleSection>
    ...
    <p>
        ...
        and fill in the values.  You can submit it to me any time the box on the right
        is green, but the more information you provide, the less I have to find before 
        I can post it.
    </p>
</CollapsibleSection>
<br/>
