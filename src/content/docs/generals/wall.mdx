...
fairly well-developed already, not brand new.  You thus must start developing your Wall pair *long* before you will start to use them, except *maybe* in Battlefield.
