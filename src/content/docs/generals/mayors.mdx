...
---
import CompareMayors from '../../../components/CompareMayors.js'
...
<CompareMayors csv="attack_mayors.csv" client:only></CompareMayors>
...
SPTable csv="toughness_mayors.csv"
...
is being debuffed.  There are tradeoffs with this hybrid approach,
...
because another use for this list is as a tiebreaker: if you are debating
