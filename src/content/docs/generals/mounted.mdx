...
As you spend more, consider replacing Theodora with George A. Custer.  You will
now be ready for really big monsters.  As you make this transition, you will want to
...
For Mounted PvP, use Roland.  There are a number of really fancy mounted generals
available, however, mounted troops are not the best choice for PvP.  You are better off
using Roland here, and saving up for premium generals in other classes.  See the advice
given to FTP players, however, be sure to reconfigure your Roland to use the Mounted
Attack skill book as soon as you stop using Li Jing.
