...
Similarly, while you can _usually_ use generals that are good for the mounted attacking use case for [Monster Hunting], that is not always true, and you can _definitally_ not depend on the reverse.
...
<AttackPairs generalClass="Mounted" useCase="Reinforcement"></AttackPairs>
