...
import { PvPAttackBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPAttackBuff.ts';
import { PvPMarchSizeBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPMarchSizeBuff';
import { PvPHPBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPHPBuff.ts';
import { PvPDefenseBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPDefenseBuff.ts';
import { PvPDeAttackBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPDeAttackBuff.ts';
import { PvPDeHPBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPDeHPBuff.ts';
import { PvPDeDefenseBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPDeDefense.ts';
import { PvPPreservationBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPPreservationBuff.ts';
import { PvPDebilitationBuff } from '@components/general/buffComputers/AttackRanking/Ground/PvPDebilitationBuff.ts';
