...
export const GroundPvPToughness = z
  .function()
  ...
  .implement(
    (eg: ExtendedGeneralType, display: DisplayType, bp: BuffParamsType) => {
      if (DEBUG) {
        console.log(`${eg.name}: GroundPvPToughness starting`);
      }
      ...
      if (DEBUG) {
        console.log(`GroundPvPToughness: ${eg.name}: BSS: ${BSS}`);
        console.log(
          `GroundPvPToughness: ${eg.name}: specialities: ${specialities}`
        );
        console.log(`GroundPvPToughness: ${eg.name}: BAS: ${BAS}`);
        console.log(`GroundPvPToughness: ${eg.name}: AES: ${AES}`);
        console.log(
          `GroundPvPToughness: ${eg.name}: TLGS (BSS & 34SS): ${TLGS}`
        );
      }
