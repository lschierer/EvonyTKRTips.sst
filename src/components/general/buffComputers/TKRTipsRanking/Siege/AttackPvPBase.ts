...
export const TKRTipsAttackSiegePvPAttack = z
  .function()
  ...
  .implement(
    (eg: ExtendedGeneralType, display: DisplayType, bp: BuffParamsType) => {
      if (DEBUG) {
        console.log(`${eg.name}: TKRTipsAttackSiegePvPAttack starting`);
      }
      ...
      if (DEBUG) {
        console.log(`TKRTipsAttackSiegePvPAttack: ${eg.name}: BSS: ${BSS}`);
        console.log(
          `TKRTipsAttackSiegePvPAttack: ${eg.name}: specialities: ${specialities}`
        );
        console.log(`TKRTipsAttackSiegePvPAttack: ${eg.name}: BAS: ${BAS}`);
        console.log(`TKRTipsAttackSiegePvPAttack: ${eg.name}: AES: ${AES}`);
        console.log(
          `TKRTipsAttackSiegePvPAttack: ${eg.name}: TLGS (BSS & 34SS): ${TLGS}`
        );
      }
