...
export const SiegePvPToughness = z
  .function()
  ...
  .implement(
    (eg: ExtendedGeneralType, display: DisplayType, bp: BuffParamsType) => {
      if (DEBUG) {
        console.log(`${eg.name}: SiegePvPToughness starting`);
      }
      ...
      if (DEBUG) {
        console.log(`SiegePvPToughness: ${eg.name}: BSS: ${BSS}`);
        console.log(
          `SiegePvPToughness: ${eg.name}: specialities: ${specialities}`
        );
        console.log(`SiegePvPToughness: ${eg.name}: BAS: ${BAS}`);
        console.log(`SiegePvPToughness: ${eg.name}: AES: ${AES}`);
        console.log(
          `SiegePvPToughness: ${eg.name}: TLGS (BSS & 34SS): ${TLGS}`
        );
      }
