          ...
          if (tb.attribute === undefined || tb.attribute === null) {
            ...
            if (
              ...
              if (!UnitSchema.enum.percentage.localeCompare(tb.value.unit)) {
                const multiplier =
                  MountedPvPAttackAttributeMultipliers?.Offensive
                    .MarchSizeIncrease ?? 0;
              ...
              if (!UnitSchema.enum.percentage.localeCompare(tb.value.unit)) {
                const multiplier =
                  MountedPvPAttackAttributeMultipliers?.Preservation
                    .Death2Souls ?? 0;
                const additional = tb.value.number * multiplier;
                if (DEBUG_GBUFF) {
                  console.log(
              ...
              if (
                ...
                if (!UnitSchema.enum.percentage.localeCompare(tb.value.unit)) {
                  ...
                  const multiplier =
                    MountedPvPAttackAttributeMultipliers?.AttackingAttackDebuff
                      .ReduceAllAttack ?? 0;
                  const additional = tb.value.number * multiplier;
                  if (DEBUG_GBUFF) {
                    console.log(
              ...
              if (
                ...
                if (!UnitSchema.enum.percentage.localeCompare(tb.value.unit)) {
                  const multiplier =
                    MountedPvPAttackAttributeMultipliers
                ...
                if (!UnitSchema.enum.percentage.localeCompare(tb.value.unit)) {
                  const multiplier =
                    MountedPvPAttackAttributeMultipliers?.Toughness
                      .AllTroopDefense ?? 0;
                  const additional = tb.value.number * multiplier;
                  if (DEBUG_GBUFF) {
                    console.log(
              ...
              if (
                ...
                if (!UnitSchema.enum.percentage.localeCompare(tb.value.unit)) {
                  ...
                  if (!ClassEnum.enum.Ground.localeCompare(tb.class)) {
                    multiplier =
                      MountedPvPAttackAttributeMultipliers
                        ?.AttackingAttackDebuff.ReduceEnemyGroundAttack ?? 0;
                  } else if (!ClassEnum.enum.Archers.localeCompare(tb.class)) {
                    multiplier =
                      MountedPvPAttackAttributeMultipliers
                        ?.AttackingAttackDebuff.ReduceEnemyRangedAttack ?? 0;
                  } else if (!ClassEnum.enum.Mounted.localeCompare(tb.class)) {
                    multiplier =
                      MountedPvPAttackAttributeMultipliers
                        ?.AttackingAttackDebuff.ReduceEnemyMountedAttack ?? 0;
                  } else if (!ClassEnum.enum.Siege.localeCompare(tb.class)) {
                    multiplier =
                      MountedPvPAttackAttributeMultipliers
                        ?.AttackingAttackDebuff.ReduceEnemySiegeAttack ?? 0;
                  }
                  const additional = tb.value.number * multiplier;
                  if (DEBUG_GBUFF) {
                    console.log(
              ...
              if (
                ...
                if (!UnitSchema.enum.percentage.localeCompare(tb.value.unit)) {
                  ...
                  if (!ClassEnum.enum.Ground.localeCompare(tb.class)) {
                    ...
                    multiplier =
                      MountedPvPAttackAttributeMultipliers?.Toughness.SiegeHP ??
                      0;
                  }
                  const additional = tb.value.number * multiplier;
                  if (DEBUG_GBUFF) {
