...
export class PairInvestment extends SizedMixin(SpectrumElement, {
  ...
  public static override get styles(): CSSResultArray {
    ...
    if (super.styles !== undefined && Array.isArray(super.styles)) {
      return [...super.styles, SpectrumTypographyCSS, SpectrumScaleMediumCSS, localStyle];
    } else {
      return [SpectrumTypographyCSS, SpectrumScaleMediumCSS, localStyle];
    }
  }
  ...
  protected override render() {
    ...
    return html`
      <div class='PairInvestment'>
        <sp-field-label for="PrimaryInvestmentLevelGroup">Primary General</sp-field-label>
        <div id="Primary General">
          <div class="row1">
            <sp-slider
        ...
        <sp-field-label for="SecondaryInvestmentLevelGroup">Secondary General</sp-field-label>
        <div id="Secondary General">
          <div class="row1">
