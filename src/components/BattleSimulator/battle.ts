...
export class EvonyBattle extends withStores(SpectrumElement, [formValues]) {
    ...
    if (fv !== null && fv !== undefined) {
      ...
      for (let i = 15; i > 0; i--) {
        ...
        if (v !== null && v !== undefined) {
          if (DEBUG) {
            console.log(`Attacker.t${i}.siege is ${v}`);
          }
          const _tier = Tier.safeParse(`t${i}`);
          if (_tier.success) {
            if (DEBUG) {
              console.log(`tier is ${_tier.data}`);
            }
            this._attackerSiegeTiers[i] = {
              tier: _tier.data,
              count: v as number,
              range:
                EvonySiege.ranges[_tier.data as keyof typeof EvonySiege.ranges],
            };
            if ((v as number) > 0) {
              ar =
                this._attackerSiegeTiers[i].range > ar
                  ? this._attackerSiegeTiers[i].range
                  : ar;
            }
          }
        }
        ...
        if (v !== null && v !== undefined) {
          if (DEBUG) {
            console.log(`Defender.t${i}.siege is ${v}`);
          }
          const _tier = Tier.safeParse(`t${i}`);
          if (_tier.success) {
            if (DEBUG) {
            ...
            if ((v as number) > 0) {
              dr =
                this._defenderSiegeTiers[i].range > dr
                  ? this._defenderSiegeTiers[i].range
                  : dr;
            }
          }
        }
      ...
      dr =
        drf !== undefined
          ...
          : dr;
      if (DEBUG) {
        window.console.log(`arf is ${arf}; arp is ${arp} ar is ${ar}`);
      }
      if (DEBUG) {
        console.log(`drf is ${drf}; drp is ${drp} dr is ${dr}`);
      }
            ...
            <div class="not-content Values">
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('aap', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('adp', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('ahp', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('arp', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
            ...
            <div class="not-content Values">
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('aaf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('adf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('ahf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('arf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
            ...
            <div class="not-content Values">
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('dap', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('ddp', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('dhp', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('drp', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
            ...
            <div class="not-content Values">
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('daf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('ddf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('dhf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
              <div class="not-content Value">
                ...
                <sp-number-field
                  ...
                  @change=${(e: CustomEvent) => {
                    addValue('drf', (e.target as NumberField).value);
                    this.requestUpdate();
                  }}
                />
              </div>
      ...
      <div class="not-content Values">
        <div class="not-content Value">
          ...
          <sp-number-field
            ...
            @change=${(e: CustomEvent) => {
              addValue(`${tier}.ground`, (e.target as NumberField).value);
              this.requestUpdate();
            }}
          />
        </div>
        <div class="not-content Value">
          ...
          <sp-number-field
            ...
            @change=${(e: CustomEvent) => {
              addValue(`${tier}.ranged`, (e.target as NumberField).value);
              this.requestUpdate();
            }}
          />
        </div>
        <div class="not-content Value">
          ...
          <sp-number-field
            ...
            @change=${(e: CustomEvent) => {
              addValue(`${tier}.mounted`, (e.target as NumberField).value);
              this.requestUpdate();
            }}
          />
        </div>
        <div class="not-content Value">
          ...
          <sp-number-field
            ...
            @change=${(e: CustomEvent) => {
              addValue(`${tier}.siege`, (e.target as NumberField).value);
              this.requestUpdate();
            }}
          />
        </div>
  ...
  render() {
    ...
    for (let i = 15; i > 0; i--) {
      ...
      `;
      if (
        this._attackerSiegeTiers[i] !== null &&
        this._attackerSiegeTiers[i] !== undefined
      ) {
      ...
      if (
        this._defenderSiegeTiers[i] !== null &&
        this._defenderSiegeTiers[i] !== undefined
      ) {
    ...
    return html`
      <div class="not-content BattleProperties">
        ${this.renderBuffSelector()} ${this.renderLayersSelector('Attacker')}
        ${this.renderLayersSelector('Defender')}
      </div>
      <div class="not-content Results">
        <div class="not-content metadata">
          <span class="not-content bold">Battlefield Size:</span> ${this
            ._battlefieldSize}
        </div>
        <div class="not-content grid troops">
          ${ttr}
          <div class="not-content ResultRow AttackersTroops">${ast}</div>
          <div class="not-content ResultRow DefendersTroops">${dst}</div>
        </div>
      </div>
    `;
  }
