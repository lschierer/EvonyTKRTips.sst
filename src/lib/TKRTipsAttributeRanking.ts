...
export type AttributeMultipliersSchemaType = z.infer<typeof AttributeMultipliersSchema>;

export const AttributeMultipliers:AttributeMultipliersSchemaType = { 
  [b.ActivationSituations.enum["Solo PvP"]]: {
    Offensive: {
      AllTroopAttack: new Map([
        [generalSpecialists.enum.Ground, 1.1],
      ]),
      GroundAttack: new Map([
        [generalSpecialists.enum.Ground, 1],
      ]),
      RangedAttack: new Map([
        [generalSpecialists.enum.Ground, 1],
      ]),
      SiegeAttack: new Map([
        [generalSpecialists.enum.Ground, 1],
      ]),
      MountedAttack: new Map([
        [generalSpecialists.enum.Ground, 1],
      ]),
      InBattleMovementBonus: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      MarchSizeIncrease: new Map([
        [generalSpecialists.enum.Ground, 2],
      ]),
      RallyCapacity: new Map([
        [generalSpecialists.enum.Ground, 0],
      ]),
      RangedRangeBonus: new Map([
        [generalSpecialists.enum.Ground, 1],
      ]),
      SiegeRangeBonusFlat: new Map([
        [generalSpecialists.enum.Ground, 1],
      ]),
      SiegeRangeBonusPercent: new Map([
        [generalSpecialists.enum.Ground, 1],
      ]),
    },
    Toughness: {
      ...
      AllTroopDefense: new Map([
        [generalSpecialists.enum.Ground, 0],
      ]),
      RangedDefense: new Map([
        [generalSpecialists.enum.Ground, 0],
      ]),
      MountedDefense: new Map([
        [generalSpecialists.enum.Ground, 0],
      ]),
      SiegeDefense: new Map([
        [generalSpecialists.enum.Ground, 0],
      ]),
      GroundDefense: new Map([
        [generalSpecialists.enum.Ground, 0],
      ]),
    },
    Preservation: {
    ...
    AttackingToughnessDebuff: {
      ...
      ReduceEnemySiegeHP: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      ReduceEnemyMountedHP: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      ReduceEnemyGroundHP: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      ReduceEnemyAllDefense: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      ReduceEnemyRangedDefense: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      ReduceEnemySiegeDefense: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
    ...
    Debilitation: {
      Wounded2Death: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      InCityWounded2Death: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
  ...
  [b.ActivationSituations.enum["Rally Owner PvP"]]: {
    Offensive: {
      AllTroopAttack: new Map([
        [generalSpecialists.enum.Ground, 1.9],
      ]),
      GroundAttack: new Map([
        [generalSpecialists.enum.Ground, 1.6],
      ]),
      RangedAttack: new Map([
        [generalSpecialists.enum.Ground, 0.5],
      ]),
      ...
      InBattleMovementBonus: new Map([
        [generalSpecialists.enum.Ground, 0.9],
      ]),
      MarchSizeIncrease: new Map([
        [generalSpecialists.enum.Ground, 2],
      ]),
