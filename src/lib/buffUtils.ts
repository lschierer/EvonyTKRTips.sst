...
const BuffEffectiveMap: BuffEffectiveMap = {
    [ActivationSituations.enum['Defense of Buildings']]: (condition:            ConditionType) => {
    ...
    [ActivationSituations.enum['Defense of Camp']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Attacking,
            Condition.enum.During_SvS,
            Condition.enum.Enemy,
    ...
    [ActivationSituations.enum['Defense of Self']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Defending,
            Condition.enum.During_SvS,
            Condition.enum.Enemy,
    ...
    [ActivationSituations.enum['Rally Owner PvP']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Attacking,
            Condition.enum.During_SvS,
            Condition.enum.Enemy,
    ...
    [ActivationSituations.enum['Rally Participant PvP']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Attacking,
            Condition.enum.During_SvS,
            Condition.enum.Marching,
    ...
    [ActivationSituations.enum['Reinforcement of Buildings']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Attacking,
            Condition.enum.Defending,
            Condition.enum.During_SvS,
    ...
    [ActivationSituations.enum['Reinforcement of Others']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Defending,
            Condition.enum.During_SvS,
            Condition.enum.Enemy,
    ...
    [ActivationSituations.enum['Rally Owner Monster']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Attacking,
            Condition.enum.During_SvS,
            Condition.enum.Marching,
    ...
    [ActivationSituations.enum['Rally Participant Monster']]: (condition: ConditionType) => {
        const trueCases: ConditionType[] = [
            Condition.enum.Attacking,
            Condition.enum.During_SvS,
            Condition.enum.Marching,
...
export const isBuffEffective = ( situation: ActivationSituationsType, condition: ConditionType) => {
