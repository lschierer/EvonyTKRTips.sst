...
I hope to offer greater insight into _why_ the general is ranked that way, and
...
For anyone trying to reproduce _my_ numbers, I have used the multipliers listed at [EvonyAnswers] as of the "4.2.0"
...
column in the sense that will help yur Mayor _have troops_ and thus _get used_ but a Mayor's contribution to your
...
how to do side-by-side comparison of generals _at different investment_ levels. Otherwise the analysis is
